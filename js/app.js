...
const wordPool = {
    ...
    'destination', 'endpoint', 'reception', 'entry', 'banquet', 'reception'],
    ...
    'nutrition', 'diet', 'digestion', 'calories'], 
    ...
    'bad', 'good', 'bridge', 'involved', 'fasten', 'join', 'network', 'gathering', 'hospitality'],
    ...
    'document', 'inventory', 'menu', 'presentation'],
    ...
    'cancerous', 'abuse', 'habit', 'habits', 'health', 'addiction', 'death', 'ashtray', 'appetite', 'break'],
    ...
    'gardening', 'growth', 'cleanup', 'mess', 'farm', 'organice', 'fresh'],
    ...
    'performance', 'development', 'progress', 'office', 'diet', 'organic', 'nutrition'],
    ...
    'association', 'interdependence', 'interconnection', 'commitement', 'communication', 'teamwork', 'balance'],
    ...
    'brewing', 'fermentation', 'craft', 'tasting', 'blend', 'aroma', 'tap', 'cheers' ],
    ...
    'refinement', 'gourmet', 'diet', 'nutrition'],
    ...
    'exchange', 'remuneration', 'transaction', 'invoice', 'settlement', 'payroll', 'billing', 'bill', 'tab'],
    ...
    'lesson', 'experience', 'flaw', 'burnt', 'spoiled'],
    ...
    'promises', 'promise', 'develop', 'enterprise', 'innovation', 'venture', 'impact', 'cookbook'],
    ...
    'sentence', 'assessment', 'evaluation', 'analysis', 'conclusion', 'review', 'palate'],
    ...
    'black', 'blend', 'aroma', 'focus', 'break', 'brunch', 'cafe'],
    ...
    'intimacy', 'bond', 'children', 'journey', 'organization', 'fusion', 'reception', 'banquet'],
    ...
    'utilization', 'capability', 'ingredients', 'harvest'],
    ...
    'insight', 'assignment', 'lunchbox', 'sous'],
    ...
    'adventure','myth', 'quest', 'scroll', 'hoard', 'feast', 'roast'],
    ...
    'maritime', 'navigation', 'wrecks', 'horizon', 'exploration', 'nautical', 'discovery', 'seafood'],
