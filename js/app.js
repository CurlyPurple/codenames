...
const wordPool = {
    ...
    'menu', 'dish', 'feast', 'entree', 'steak', 'eat', 'picnic', 'restaurant','nutrient', 'cafeteria',
    ...
    'destination', 'endpoint', 'reception', 'entry'],
    ...
    'limits', 'limitation', 'detriment', 'decline', 'susceptibility', 'vulnerability', 'ergonomics', 'rest'],
    ...
    'backlash', 'stress', 'fear', 'damage', 'regret', 'suffer', 'fail', 'failure', 'enforcement', 'policy'],
    ...
    'cancerous', 'abuse', 'habit', 'habits', 'health', 'addiction', 'death', 'ashtray'],
    ...
    'performance', 'development', 'progress', 'office'],
    ...
    'association', 'interdependence', 'interconnection', 'commitement', 'communication', 'teamwork'],
    ...
    'brewing', 'fermentation', 'craft', 'tasting', 'blend', 'aroma', 'tap' ],
    ...
    'exchange', 'remuneration', 'transaction', 'invoice', 'settlement', 'payroll', 'billing'],
    ...
    'contribution', 'contributions', 'altruism', 'benefaction', 'generous', 'generosity', 'support', 'impact', 'volunteer'],
    ...
    'allow', 'explicit', 'slip', 'waiver', 'preapproved', 'approve', 'seek', 'obtain', 'boss'],
    ...
    'mean', 'behavior', 'brain', 'celebrity', 'quirky', 'flirty', 'psychology', 'disposition', 'traits', 'profile', 'office'],
    ...
    'termite', 'stove', 'stoves', 'splinter', 'timber', 'finish', 'home', 'mahogany', 'walnut' ],
    ...
    'truck', 'stink', 'throw', 'toss', 'rubbish', 'conjecture', 'mess', 'clutter'],
    ...
    'intimacy', 'bond', 'children', 'journey', 'organization'],
    ...
    'adventure','myth', 'quest', 'scroll', 'hoard'],
