...
const wordPool = {
    ...
    'newsroom', 'review', 'foodie', 'live', 'journalism','romance'],
    ...
    'diet', 'full', 'hungover','debt','heartbreak'],
    ...
    'full','treated','purchase','baking','aficionado'],
    ...
    'sacrifice', 'rare', 'thirst', 'ambulance', 'clown','hemophobia','money',],
    ...
    'gardening', 'growth', 'cleanup', 'mess', 'farm', 'organic', 'fresh','trails', 'footprints','picnic', 'backyard','barren'],
    ...
    'understanding', 'epistemology', 'scholar', 'research', 'study', 'library', 'dumb','economics'],
    ...
    'intimacy', 'bond', 'children', 'journey', 'organization', 'fusion', 'reception', 'banquet','suit','dress','cheating','polygamy'],
    ...
    'insight', 'assignment', 'lunchbox', 'sous', 'homeroom','dilation'],
    ...
    'adventure','myth', 'quest', 'scroll', 'hoard', 'feast', 'roast', 'landing', 'land','tales','tails','green'],
    ...
    'maritime', 'navigation','marine', 'wrecks', 'horizon', 'exploration', 'nautical', 'discovery', 'seafood', 'shipment', 'port','cruise','yacht'],
    ...
    'ration', 'mess', 'frontline', 'deployment', 'invasion','gathering','funding','marine','fair']
}
